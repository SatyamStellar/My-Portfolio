...
import { github, pplay as pplay } from "../assets";
  ...
  return (
    <motion.div variants={fadeIn("up", "spring", index * 0.5, 0.75)}>
      <Tilt
        ...
        <div className="mt-5">
          <h3 className="text-sec font-newtype font-bold text-[24px]">{name}</h3>
          <p className="text-white font-semibold text-[12px] mt-2">{description}</p>
        </div>
