...
const Computers = ({ isMobile, isXlMobile }) => {
  const computer = useGLTF("./minirobot/scene.gltf");

  return (
    <mesh>
      <hemisphereLight intensity={isMobile ? 6 : 7} groundColor="black" />
      ...
      <primitive
        ...
        position={isMobile ? [0, -0.5, 0] : isXlMobile ? [0, 0, 0] : [0, 0, 0]}
...
const ComputersCanvas = () => {
  ...
  useEffect(() => {
    ...
    handleMediaQuery(); // Initial check
  ...
  return (
    ...
    >
      <Suspense fallback={<CanvasLoader />}>
        ...
        />
        <Computers isXlMobile={isXlMobile} isMobile={isMobile} />
      </Suspense>
      <Preload all />
    </Canvas>
  );
