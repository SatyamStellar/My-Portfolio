  ...
  return (
    <section className="relative w-full h-screen mx-auto">
      <div className={`${styles.paddingX} absolute inset-0 top-[120px] max-w-7xl mx-auto flex flex-row items-start gap-5`}>
        ...
        <div>
          <h1 className={`${styles.heroHeadText} text-white`}>Hi, I'm <span className="text-purple-600">Satyam</span></h1>
          <p className={`${styles.heroSubText} mt-2 text-white-100`}>I'm a creative <br className="sm:block hidden" /> frontend developer</p>
        </div>
      </div>
      <ComputersCanvas />
